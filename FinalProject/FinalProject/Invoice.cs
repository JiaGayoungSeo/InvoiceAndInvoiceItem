       ...
       public string CheckShipping(bool Shipping)
        ...
        public decimal _TotalPrice
        {
            get
            {
                ...
                connection.Open();
                string sql = $"SELECT * FROM InvoiceItems i WHERE InvoiceID = {this.InvoiceID}";
        ...
        public override string ToString() => $"{_InvoiceID,6}{"",15}\t{_CustomerName,-25}{"",15}\t{_CustomerEmail,-25}{"",15}\t{_TotalPrice,-35:C2}{"",15}\t{CheckShipping(Shipping),-10}";
